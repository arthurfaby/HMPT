    ...
    return (
        <div className="items-center justify-center">
            ...
            <div className="absolute bottom-0 right-8">
               <PopoverString pictureRef={pictureRef} onSubmit={handleSubmit} placeHolder="Nouvelle photo de profil"></PopoverString> 
            </div>
            </div>
        </div>
