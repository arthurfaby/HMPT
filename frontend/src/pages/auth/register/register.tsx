    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                ...
                <Input type="text" placeholder="Prénom" name="first_name" value={firstName} onChange={(event) => setFirstName(event.currentTarget.value)} className=""/> 
                <Input type="text" placeholder="Nom" name="last_name" value={lastName} onChange={(event) => setLastName(event.currentTarget.value)} className=""/> 
            <DialogClose asChild>
                <Button type="button" onClick={() => handleSubmit(username, email, password, firstName, lastName)}>
                    Register
                </Button>
            </DialogClose>
            </DialogContent>
